      ...
      <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
        ...
        <div class="mt-5 flex-1 h-0 overflow-y-auto">
          <nav class="px-2 space-y-1">
            ...
            <a href="#" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-3 text-base font-medium rounded-md">
              <!--
            ...
            <a href="#" class="text-gray-600 hover:bg-gray-50  group flex items-center px-2 py-3 text-base font-medium rounded-md">
